...
@WebServiceClient(name = "Service", 
                  wsdlLocation = "http://www.qanalytics.cl/ws_status_gps/service.asmx?wsdl", 
...
public class Service extends javax.xml.ws.Service {
    ...
    public static final QName ServiceSoap = 
        new QName("http://tempuri.org/", "ServiceSoap");
    public static final QName ServiceSoap12 = 
        new QName("http://tempuri.org/", "ServiceSoap12");
    static {
        URL url = null;
        try {
            url = 
new URL("http://www.qanalytics.cl/ws_status_gps/service.asmx?wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from http://www.qanalytics.cl/ws_status_gps/service.asmx?wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
